                            ...
                            matchedCourses.length > 0 ? (
                                <div className="w-full ">
                                    {matchedCourses.map((course) => (
                                        <div key={course._id} className=" w-full md:flex md:space-x-4">
                                            ...
                                            <div className='w-full md:w-1/2 p-2 md:p-6 space-y-4 md:space-y-6' >
                                                <div className='space-y-2 md:space-y-4 ' >
                                                    ...
                                                    <div className='flex space-x-4 font-generalregular ' >
                                                        ...
                                                        <div className='flex space-x-1 items-center bg-linear-to-r from-pink-500 via-pink-600 to-red-500 hover:from-red-500 hover:via-pink-600 hover:to-pink-500 px-3 transition-colors duration-500  md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-2xl text-sm md:text-base text-white ' >
                                                            <div><PiClockBold /></div>
